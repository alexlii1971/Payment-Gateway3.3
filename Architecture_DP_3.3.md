...
- [三、模块划分与职责](#三模块划分与职责)  
- [四、技术实现路径](#四技术实现路径)  
  - [4.1 支付回调地址动态生成](#41-支付回调地址动态生成)  
  - [4.2 订单存储 `site_id`](#42-订单存储-site_id)  
  - [4.3 Webhook 自动注册与维护](#43-webhook-自动注册与维护)  
  - [4.4 网络级与子站级管理地址](#44-网络级与子站级管理地址)  
- [五、优化分析与调整](#五优化分析与调整)  
  - [5.1 模块通信解耦](#51-模块通信解耦)  
  - [5.2 支付配置继承机制](#52-支付配置继承机制)  
- [六、关键代码结构](#六关键代码结构)  
  - [6.1 模块注册与加载](#61-模块注册与加载)  
  - [6.2 支付状态同步（API 查询）](#62-支付状态同步api-查询)  
  - [6.3 Webhook 安全验证](#63-webhook-安全验证)  
- [七、部署与兼容性](#七部署与兼容性)  
  - [7.1 多站点兼容性](#71-多站点兼容性)  
  - [7.2 数据库表设计](#72-数据库表设计)  
- [八、未来扩展方向](#八未来扩展方向)  
- [九、数据库与数据隔离设计](#九数据库与数据隔离设计)  
  - [9.1 数据存储策略](#91-数据存储策略)  
  - [9.2 日志隔离设计](#92-日志隔离设计)  
  - [9.3 分表查询优化](#93-分表查询优化)  
- [十、安全性增强设计](#十安全性增强设计)  
  - [10.1 支付请求防篡改](#101-支付请求防篡改)  
  - [10.2 Webhook 安全防护](#102-webhook-安全防护)  
  - [10.3 敏感数据加密](#103-敏感数据加密)  
- [十一、网络级与子站级管理界面实现](#十一网络级与子站级管理界面实现)  
  - [11.1 网络级管理界面](#111-网络级管理界面)  
  - [11.2 子站级管理界面](#112-子站级管理界面)  
  - [11.3 权限控制](#113-权限控制)  
- [十二、异常处理与容灾机制](#十二异常处理与容灾机制)  
  - [12.1 支付流程异常处理](#121-支付流程异常处理)  
  - [12.2 Webhook 失败容灾](#122-webhook-失败容灾)  
  - [12.3 日志与监控](#123-日志与监控)  
- [十三、性能优化方案](#十三性能优化方案)  
  - [13.1 静态资源缓存](#131-静态资源缓存)  
  - [13.2 数据库查询优化](#132-数据库查询优化)  
  - [13.3 异步任务队列](#133-异步任务队列)  
- [十四、测试与部署流程](#十四测试与部署流程)  
  - [14.1 单元测试覆盖](#141-单元测试覆盖)  
  - [14.2 灰度发布策略](#142-灰度发布策略)  
  - [14.3 回滚方案](#143-回滚方案)  
- [十五、最终架构总结](#十五最终架构总结)  
  - [15.1 架构优势](#151-架构优势)  
  - [15.2 待优化点](#152-待优化点)  
